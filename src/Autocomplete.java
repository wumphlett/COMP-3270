   ...
   /**
    ...
    public static class TrieAutocomplete implements Autocompletor {
        ...
        private void add(String word, double weight) {
            ...
            for (char letter : word.toCharArray()) {
                ...
                if (!current.children.containsKey(letter)) {
                    Node child = new Node(letter, current, weight);
        ...
        public String topMatch(String prefix) {
            ...
            double largestWeight = current.mySubtreeMaxWeight;
            if (current.myWeight == largestWeight) {
                return current.myWord;
            }
            while (current.myWeight != largestWeight) {
                for (Node child : current.children.values()) {
                    if (child.mySubtreeMaxWeight == largestWeight) {
                        current = child;
                        break;
                    }
                }
